...
- :a: [**Bonnes pratiques**]{.orange} de développement
...
- Apprentissage par la pratique
    ...
    - Maîtrise de différentes étapes importantes :bullettrain_front:
...
## Evaluation {.nonincremental auto-animate=true}

- Pas d'évaluation :tada:
- Des connaissances précieuses pour **gagner en indépendance** face aux concurrents
- [**Objectif**]{.orange} : mise en pratique [**réaliste**]{.orange} des notions étudiées
    - [**Problématique métier**]{.blue2}
    - [**Données réelles**]{.blue2}

## Ce que vous avez à gagner {.nonincremental auto-animate=true}

- Comprendre les enjeux dans un contexte où l'[**open source**](https://itsocial.fr/intelligence-artificielle/intelligence-artificielle-articles/de-lopen-source-a-lopen-core-la-nouvelle-guerre-dinfluence-dans-lia/) est un atout 
- Sensibilisation aux bonnes pratiques :gem:
- Gagner en indépendance pour s'affranchir de solutions propriétaires :office:
- Capable de collaborer plus facilement sur des projets avec le monde :earth_africa:
- Démystifier par la pratique les étapes d'industrialisation :arrow_right: séquencer les outils
- Gagner en technicité 


# Partie :a: : bonnes pratiques de développement
