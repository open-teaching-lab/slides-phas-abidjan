...
[Source](https://www.qlik.com/us/data-lake)
...
![](img/row-column.png){height="350" fig-align="center"}
...
## :three: Frameworks de traitement *in-memory*

- Le *framework* adapté dépend de la [**volumétrie**]{.orange}
  - Données [**volumineuses**]{.blue2} : calcul [**in-memory**]{.blue2} optimisé
    - [Arrow](https://arrow.apache.org/overview/) : orientation fichier
    - [DuckDB](https://duckdb.org/) : orientation base de données (`SQL`)
  - Données [**massives**]{.blue2} : calcul [**distribué**]{.blue2}
...
- [**Mettre en production**]{.orange} : faire [**vivre**]{.blue2} une application dans l'espace de ses [**utilisateurs**]{.blue2}
    - Notion simple mais mise en oeuvre complexe !

- La majorité des projets de data-science [**ne délivrent pas de valeur**]{.blue2} ([1](https://sloanreview.mit.edu/projects/expanding-ais-impact-with-organizational-learning/), [2](https://hdsr.mitpress.mit.edu/pub/2fu65ujf/release/6), [3](https://scholarspace.manoa.hawaii.edu/server/api/core/bitstreams/a245101b-61cf-4695-9b9e-b95cb30d97ca/content))

## Dépasser le "mur de la production"

- Besoin d'organisations plus [**continues**]{.orange}

. . .

![](img/exploration-production.png){fig-align="center"}

## Plan

:one: [**Valorisation**]{.blue2}
...
- Consignes sur le [site du cours](https://ensae-reproductibilite.github.io/website/chapters/application.html)
    - Partie 4 : automatisation de la livraison d'une application avec l’intégration continue
    - Partie 5 : déploiement d'une application
