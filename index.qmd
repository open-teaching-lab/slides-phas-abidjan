...
![](img/ci-cd.png){fig-align="center" height=250}

## Pipeline [***DataOps***]{.orange} complet

- Intégration de toutes les étapes dans un [**pipeline**]{.orange} de données
    - Modélisation sous forme de [**graphe acyclique dirigé**]{.blue2} ([**DAG**]{.blue2})
...
![Source : [ibm.com](https://public.dhe.ibm.com/software/data/sw-library/analytics/data-science-lifecycle/#model-implementation)](img/exploration-production.png){fig-align="center" height=300}
